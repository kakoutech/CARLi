...
namespace App\Http\Livewire\ReflectiveJournal;

use App\Models\ReflectiveJournalStep;
use Livewire\Component;
use Livewire\WithFileUploads;

class ManageStep extends Component
{
    use WithFileUploads;
    ...
    public function save()
    {
        ...
        return redirect()->route('dashboard.reflective-journal.edit', [$this->edit_step->id])->with(['success' => 'Reflective Journal Step Updated.']);
    }

    public function render()
    {
        return view(
            'livewire.reflective-journal.manage-step',
            [
            ]
        );
    }
