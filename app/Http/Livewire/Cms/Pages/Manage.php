...
namespace App\Http\Livewire\Cms\Pages;
...
class Manage extends Component
{
    ...
    public function save()
    {
        ...
        return redirect()->route('dashboard.cms.edit', [$this->edit_page->id])->with(['success' => 'Page Updated.']);
    }

    public function render()
    {
        return view('livewire.cms.pages.manage');
    }
}
