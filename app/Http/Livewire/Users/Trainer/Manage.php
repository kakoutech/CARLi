...
namespace App\Http\Livewire\Users\Trainer;
...
class Manage extends Component
{
    ...
    public $rules = [
        ...
        'edit_user.employer_id' => ['required'],
    ];
    ...
    public function save()
    {
        ...
        $this->edit_user->account_type = 'trainer';
        ...
        return redirect()->route('dashboard.trainers.edit', [$this->edit_user->id])->with(['success' => 'Trainer Updated.']);
    }

    public function render()
    {
        return view('livewire.users.trainer.manage');
    }
}
