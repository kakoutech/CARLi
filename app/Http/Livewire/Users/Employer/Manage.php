...
namespace App\Http\Livewire\Users\Employer;
...
class Manage extends Component
{
    ...
    public $rules = [
        ...
        'edit_user.company_name' => ['required'],
    ];
    ...
    public function save()
    {
        ...
        $this->edit_user->account_type = 'employer';
        ...
        return redirect()->route('dashboard.employers.edit', [$this->edit_user->id])->with(['success' => 'Employer Updated.']);
    }

    public function render()
    {
        return view('livewire.users.employer.manage');
    }
}
