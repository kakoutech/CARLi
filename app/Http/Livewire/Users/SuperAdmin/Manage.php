...
namespace App\Http\Livewire\Users\SuperAdmin;
...
class Manage extends Component
{
    ...
    public function mount($user)
    {
        ...
        $this->permissions = getGroupedPermissionData($this->edit_user);
    }
    ...
    public function save()
    {
        ...
        $this->edit_user->account_type = 'admin';
        ...
        foreach ($this->permissions as $group => $actions) {
            foreach ($actions as $action => $value) {
                ...
                $this->edit_user->updatePermission($action, $value);
            }
        }
        ...
        return redirect()->route('dashboard.super-admins.edit', [$this->edit_user->id])->with(['success' => 'Super Admin Updated.']);
    }

    public function render()
    {
        return view('livewire.users.super-admin.manage');
    }
}
