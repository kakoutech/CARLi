    ...
    <div class="mt-10">
        ...
        <div class="container">
                ...
                <div class="flex items-center justify-between my-4 mx-5">
                    ...
                    @if (auth()->user()->isTrainer())
                        ...
                        <div>
                            ...
                            <a href="{{ route('strategy-tools.add') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add Content</a>
            ...
            @else 
                ...
                <div class="my-8 font-bold text-lg text-center">Strategy Tools
            ...
            <div class="grid md:grid-cols-2">
                ...
                @foreach ($articles as $article)
                    ...
                    @include('strategy-tool.card', ['article' => $article])
