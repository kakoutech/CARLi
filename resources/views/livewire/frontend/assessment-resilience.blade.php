                        ...
                        @foreach ($question->statements as $statement_index => $statement)
                            ...
                            <div class="my-6">
                                ...
                                <div class="flex gap-10 items-center justify-center">
                                    ...
                                    <label for="question_{{ $question->id }}_statement_{{ $statement->id }}_1" class="bg-white py-4 px-2 border rounded w-full h-full cursor-pointer">
                                    ...
                                    <label for="question_{{ $question->id }}_statement_{{ $statement->id }}_2" class="bg-white py-4 px-2 border rounded w-full h-full cursor-pointer">
                                    ...
                                    <label for="question_{{ $question->id }}_statement_{{ $statement->id }}_3" class="bg-white py-4 px-2 border rounded w-full h-full cursor-pointer">
                                    ...
                                    <label for="question_{{ $question->id }}_statement_{{ $statement->id }}_4" class="bg-white py-4 px-2 border rounded w-full h-full cursor-pointer">
                                    ...
                                    <label for="question_{{ $question->id }}_statement_{{ $statement->id }}_5" class="bg-white py-4 px-2 border rounded w-full h-full cursor-pointer">
        ...
        @if ($current_question > count($questions))
            ...
            <div>
                ...
                @php 
                    ...
                    if (
                        ($types['optimism'] == 'avg' || $types['optimism'] == 'high') && 
                        ($types['social-support'] == 'avg' || $types['social-support'] == 'high') && 
                        ($types['purpose'] == 'avg' || $types['purpose'] == 'high') && 
                        ($types['humourplayfulness'] == 'avg' || $types['humourplayfulness'] == 'high')
                    ) {
                        echo '<div class="mt-4 p-5 bg-green-500 text-white"><div class="text-lg font-bold mb-2">HIGH RESILIENCE</div><div>medium to high scores in all sub-scales – integrates with the four spectrum profiles to create a description</div></div>';
                    } else if (
                        ($types['optimism'] == 'avg') && 
                        ($types['social-support'] == 'avg') && 
                        ($types['purpose'] == 'avg') && 
                        ($types['humourplayfulness'] == 'avg')
                    ) {
                        echo '<div class="mt-4 p-5 bg-green-500 text-white"><div class="text-lg font-bold mb-2">AVERAGE RESILIENCE</div><div>average scores in all sub-scales – integrates with the four spectrum profiles to create a description</div></div>';
                    } else if (
                        ($types['optimism'] == 'avg' || $types['optimism'] == 'low') && 
                        ($types['social-support'] == 'avg' || $types['social-support'] == 'low') && 
                        ($types['purpose'] == 'avg' || $types['purpose'] == 'low') && 
                        ($types['humourplayfulness'] == 'avg' || $types['humourplayfulness'] == 'low')
                    ) {
                        echo '<div class="mt-4 p-5 bg-green-500 text-white"><div class="text-lg font-bold mb-2">LOW RESILIENCE</div><div>medium to low scores in all sub-scales – integrates with the four spectrum profiles to create a description</div></div>';
                    }
            ...
            <div class="flex justify-between md:justify-center gap-3 mt-6">
                ...
                <a href="{{ route('profile') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"> My Profile </a>
