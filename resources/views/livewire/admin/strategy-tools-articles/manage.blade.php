            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    @if ($edit_article->uploads)
                        ...
                        <a href="{{ $edit_article->getFile() }}" class="font-bold mt-6 block" target="_blank">Preview Current File</a>
                ...
                <div class="sm:col-span-3">
                    ...
                    <img class="w-full h-64 mt-6" src="{{ $edit_article->getImage() }}">
    ...
    <div class="pt-5">
        ...
        <div class="flex justify-end">
            ...
            @if (auth()->user()->isTrainer())
                ...
                <a href="{{ route('strategy-tools') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</a>

            @else 

                <a href="{{ route('admin.strategy-tools') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</a>
