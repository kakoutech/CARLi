<form wire:submit.prevent="save" class="space-y-8 divide-y divide-gray-200">
    ...
    <div class="space-y-8 divide-y divide-gray-200">
        ...
        <div>
            ...
            <div>
                ...
                <h3 class="text-lg leading-6 font-medium text-gray-900">Step Content</h3>

                <p class="mt-1 text-sm text-gray-500">Fill in the form below to update the step content.</p>
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-6">
                    ...
                    <label for="title" class="block text-sm font-medium text-gray-700"> Step Title </label>
                ...
                <div class="sm:col-span-6">
                    ...
                    <label for="content" class="block text-sm font-medium text-gray-700"> Step Content </label>
    ...
    <div class="pt-5">
        ...
        <div class="flex justify-end">
            ...
            <a href="{{ route('admin.reflective-journal') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</a>
