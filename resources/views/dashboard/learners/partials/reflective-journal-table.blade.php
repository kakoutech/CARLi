<div class="flow-root">
    ...
    <div class="hidden items-center bg-gray-200 md:flex">
        ...
        <div class="w-8/12 flex-grow px-4 py-2">
            <span class="block text-sm font-bold uppercase">Date</span>
        </div>
                    ...
                    <div class="items-center md:flex">
                        ...
                        <div class="flex-grow px-4 md:w-3/12">
                            ...
                            <p class="truncate text-lg font-bold text-gray-900">
                                {{ $entry->completed_at ? $entry->completed_at->format('d/m/Y H:i A') : '-' }}</p>
                        ...
                        <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-2/12">
                            ...
                            <a class="cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                href="{{ route('dashboard.learners.view.journals.view', [$entry->user->id, $entry->id]) }}">
                                View Responses </a>
    ...
    @else
        <div class="m-5">
            ...
            <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                ...
                <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No journals found matching your
                    criteria. </span>
