...
@section('breadcrumbs')
    <div class="leading-none">
        ...
        <a href="{{ route('dashboard.learners.enrolled') }}">Enrolled</a>
...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Enrolled Learners</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.learners.enrolled.enroll') }}">
                            ...
                            <div class="items-center md:flex">
                                ...
                                <div class="flex-grow px-4 md:w-3/12">
                                    ...
                                    <div class="flex items-center justify-start gap-5">
                                        ...
                                        <div><a
                                                href="{{ route('dashboard.learners.view', [$user->id]) }}"class="text-lg font-bold text-gray-900 truncate">{{ $user->getFullName() }}</a>
                                        </div>
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No learners found matching
                            your
                            criteria. </span>
