...
@section('content')
    ...
    <div class="flex items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">MCQs</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.courses.mcqs.add') }}">
                ...
                <form action="{{ route('dashboard.courses.mcqs.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
    ...
    <div class="rounded-lg bg-white shadow">
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Subtopic</span>
                </div>
                        ...
                        <div class="py-4">
                            ...
                            <div class="items-center md:flex">
                                <div class="w-12 flex-shrink-0 flex-grow-0 px-4">
                                    <input class="select-me" name="select-me[]" type="checkbox" value="{{ $set->id }}">
                                </div>
                                ...
                                <div class="flex-grow px-4 md:w-4/12">
                                    ...
                                    <div>
                                        ...
                                        <div class="block truncate text-lg font-bold text-gray-900">{{ $set->getName() }}
                                        </div>
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <!--<a class="cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50" href="{{ route('dashboard.courses.mcqs.view', [$set->id]) }}"> View </a>-->
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.courses.mcqs.edit', [$set->id]) }}"> Edit </a>

                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this MCQ?')) document.getElementById('delete_course_{{ $set->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.courses.mcqs.delete', [$set->id]) }}" class="inline"
                                        id="delete_course_{{ $set->id }}" method="POST">
