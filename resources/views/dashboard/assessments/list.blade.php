...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Assessment</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.assessments.add') }}">
                ...
                <form action="{{ route('dashboard.assessments.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                ...
                <form class="relative text-white focus-within:text-gray-600" method="GET">
                    ...
                    <input
                        ...
                        name="search" placeholder="Search Assessments" type="search"
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase"># Groups</span>
                </div>

                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase"># Questions</span>
                </div>

                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase"># Responses</span>
                </div>
            ...
            @if ($assessments && $assessments->count())
                            ...
                            <div class="items-center md:flex">
                                ...
                                <div class="flex-grow px-4 md:w-4/12">
                                    ...
                                    <div>
                                        ...
                                        <a class="block truncate text-lg font-bold text-gray-900"
                                            href="{{ route('dashboard.assessments.view', [$assessment->id]) }}">{{ $assessment->getName() }}</a>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-2/12">
                                    ...
                                    <span class="text-gray-700 md:hidden">Group Count:</span>
                                    {{ $assessment->getGroupcount() }}

                                </div>

                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-2/12">

                                    <span class="text-gray-700 md:hidden">Question Count:</span>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    <span class="text-gray-700 md:hidden">Response Count:</span>

                                    {{ $assessment->getResponseCount() }}
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.assessments.edit', [$assessment->id]) }}"> Edit </a>

                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this assessment?')) document.getElementById('delete_assessment_{{ $assessment->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.assessments.delete', [$assessment->id]) }}"
                                        class="inline" id="delete_assessment_{{ $assessment->id }}" method="POST">
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No assessments found matching
                            your criteria. </span>
