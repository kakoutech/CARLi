...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Pages</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <form action="{{ route('dashboard.cms.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                ...
                <form class="relative text-white focus-within:text-gray-600" method="GET">
                    ...
                    <input
                        ...
                        name="search" placeholder="Search Pages" type="search" value="{{ request()->input('search') }}">
                </form>
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-4/12 flex-grow px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Page</span>
                </div>

                <div class="w-4/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Slug</span>
                </div>
                        ...
                        <div class="py-4">
                            ...
                            <div class="items-center space-x-4 md:flex">
                                ...
                                <div class="w-12 flex-shrink-0 flex-grow-0 px-4">
                                    <input class="select-me" name="select-me[]" type="checkbox" value="{{ $page->id }}">
                                </div>

                                <div class="px-4 md:w-4/12">

                                    <p class="truncate text-lg font-bold text-gray-900">{{ $page->getName() }}</p>

                                    <p class="truncate text-sm text-gray-500">{{ $page->getPermalink() }}</p>
                                ...
                                <div class="px-4 md:w-4/12">
                                    ...
                                    <p class="text-md truncate font-bold text-gray-500">/{{ $page->slug }}</p>

                                </div>

                                <div class="hidden w-3/12 px-4 md:flex">
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <a class="cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ $page->getPermalink() }}" target="_blank"> View </a>
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.cms.edit', [$page->id]) }}"> Edit </a>

                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this page?')) document.getElementById('delete_page_{{ $page->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.cms.delete', [$page->id]) }}" class="inline"
                                        id="delete_page_{{ $page->id }}" method="POST">
                                        @csrf
                                        @method('delete')
                                    </form>
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No pages found matching your
                            criteria. </span>
