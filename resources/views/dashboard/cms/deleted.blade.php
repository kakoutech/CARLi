...
@section('breadcrumbs')
    <div class="leading-none">
        ...
        <a href="{{ route('dashboard.cms.deleted') }}">Deleted Pages</a>
                    ...
                    @foreach ($pages as $page)
                        <div class="py-4">
                            ...
                            <div class="items-center space-x-4 md:flex">
                                ...
                                <div class="hidden min-w-0 flex-1 px-4 md:flex">
                                ...
                                <div class="flex w-1/12 flex-shrink-0 flex-grow-0 justify-end px-4">
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to restore this page?')) document.getElementById('restore_page_{{ $page->id }}').submit()">
                                        Restore </a>

                                    <form action="{{ route('dashboard.cms.restore', [$page->id]) }}" class="inline"
                                        id="restore_page_{{ $page->id }}" method="POST">
                                        @csrf
                                    </form>
