...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Certificates</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.certificates.add') }}">
                ...
                <form action="{{ route('dashboard.certificates.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                ...
                <form class="relative text-white focus-within:text-gray-600" method="GET">
                    ...
                    <input
                        ...
                        name="search" placeholder="Search Certificates" type="search"
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Award Count</span>
                </div>
                        ...
                        <div class="py-4">
                            ...
                            <div class="items-center md:flex">
                                ...
                                <div class="w-12 flex-shrink-0 flex-grow-0 px-4">
                                    <input class="select-me" name="select-me[]" type="checkbox"
                                ...
                                <div class="flex-grow px-4 md:w-6/12">
                                    ...
                                    <div>
                                        ...
                                        <a class="truncate text-lg font-bold text-gray-900"
                                            href="{{ route('dashboard.certificates.edit', [$certificate->id]) }}">{{ $certificate->getName() }}</a>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-2/12">
                                    ...
                                    {{ $certificate->getAwardCount() }} Awarded
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-2/12">
                                    ...
                                    <a class="toggle-award-certificate-{{ $certificate->id }}-modal cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href=""> Award </a>
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.certificates.edit', [$certificate->id]) }}"> Edit </a>

                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this certificate?')) document.getElementById('delete_certificate_{{ $certificate->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.certificates.delete', [$certificate->id]) }}"
                                        class="inline" id="delete_certificate_{{ $certificate->id }}" method="POST">
                                    ...
                                    <div class="fixed top-0 left-0 flex hidden h-full w-full items-center justify-center bg-black bg-opacity-20"
                                        id="award-certificate-{{ $certificate->id }}" style="z-index:99;">
                                        ...
                                        <div class="w-full max-w-lg rounded-lg bg-white shadow-lg">
                                            ...
                                            <div class="p-5">
                                                ...
                                                @livewire('certificates.award', [$certificate->id, null], $certificate->id)
                                    ...
                                    <script>
                                        var btns = document.querySelectorAll('.toggle-award-certificate-{{ $certificate->id }}-modal');

                                        for (let i = 0; i < btns.length; i++) {
                                            btns[i].addEventListener("click", function(e) {
                                                e.preventDefault();
                                                document.querySelector('#award-certificate-{{ $certificate->id }}').classList.toggle('hidden');
                                            });
                                        }
                                    </script>
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No certificates found matching
                            your criteria. </span>
