...
@section('breadcrumbs')
    <div class="leading-none">
        ...
        <a href="{{ route('dashboard.trainers.deleted') }}">Deleted</a>
...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Trainers</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.trainers.add') }}">
                ...
                <form class="relative text-white focus-within:text-gray-600" method="GET">
                    ...
                    <input
                        ...
                        name="search" placeholder="Search Trainers" type="search"
    ...
    <div class="rounded-b-lg bg-white shadow">
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Employer</span>
                </div>
                ...
                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-center text-sm font-bold uppercase">Learners</span>
                </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-grow px-4 md:w-2/12">
                                    ...
                                    <div class="flex items-center justify-start gap-5">
                                        ...
                                        <div><a class="truncate text-lg font-bold text-gray-900"
                                                href="{{ route('dashboard.trainers.view', [$user->id]) }}">{{ $user->getFullName() }}</a>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        onclick="if(confirm('Are you sure you want to restore this trainer?')) document.getElementById('restore_user_{{ $user->id }}').submit()">
                                        Restore </a>

                                    <form action="{{ route('dashboard.trainers.restore', [$user->id]) }}" class="inline"
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No trainers found matching your
                            criteria. </span>
