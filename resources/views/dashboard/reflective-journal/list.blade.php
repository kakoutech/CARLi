...
@section('breadcrumbs')
    <div class="leading-none">
        ...
        <a href="{{ route('dashboard.reflective-journal') }}">Steps</a>
...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Questions</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.reflective-journal.add') }}">
                ...
                <form action="{{ route('dashboard.reflective-journal.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
                ...
                <form class="relative text-white focus-within:text-gray-600" method="GET">
                    ...
                    <input
                        ...
                        name="search" placeholder="Search Questions" type="search"
    ...
    <div class="rounded-b-lg bg-white shadow">
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2 text-center">
                    <span class="block text-sm font-bold uppercase">Order</span>
                </div>

                <div class="w-4/12 flex-grow px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Question</span>
                </div>

                <div class="w-2/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Type</span>
                </div>

                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Submissions</span>
                </div>
                        ...
                        <div class="py-4">
                            ...
                            <div class="items-center md:flex">
                                ...
                                <div class="w-12 flex-shrink-0 flex-grow-0 px-4">
                                    <input class="select-me" name="select-me[]" type="checkbox" value="{{ $step->id }}">
                                </div>

                                <div class="flex-shrink-0 flex-grow-0 items-start px-4 text-center md:w-1/12">
                                ...
                                <div class="flex-grow px-4 md:w-4/12">
                                    ...
                                    <p class="truncate text-lg font-bold text-gray-900">{{ $step->getTitle() }}</p>
                                    ...
                                    <div class="text-sm">{!! $step->getContent() !!}</div>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-2/12">
                                    ...
                                    <span
                                        class="text-sm text-gray-600">{{ $step->accept_input ? 'Accepts Input' : 'Display Only' }}</span>

                                </div>

                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">

                                    <span class="md:hidden">Submission Count:</span>

                                    {{ $step->getSubmissionCount() }}
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <a class="cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.reflective-journal.edit', [$step->id]) }}"> Edit </a>
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this page?')) document.getElementById('delete_step_{{ $step->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.reflective-journal.delete', [$step->id]) }}"
                                        class="inline" id="delete_step_{{ $step->id }}" method="POST">
                                        @csrf
                                        @method('delete')
                                    </form>
            ...
            @else
                <div class="m-5">
                    ...
                    <div class="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
                        ...
                        <span class="font-mediu mt-2 block text-lg font-bold text-gray-400"> No steps found matching your
                            criteria. </span>
