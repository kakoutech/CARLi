...
@section('content')
    ...
    <div class="items-center justify-between rounded-t-lg bg-brand-500 px-3 py-3 md:flex">
        ...
        <div class="flex flex-col justify-center pl-3 text-white">
            <div class="mb-5 text-xl font-bold leading-none md:mb-0">Classes</div>
        ...
        <div>
            ...
            <div class="gap-3 md:flex">
                ...
                <a class="mb-3 flex items-center rounded-md bg-white py-2 px-5 leading-5 text-gray-800 md:mb-0"
                    href="{{ route('dashboard.virtual-classes.add') }}">
                ...
                <form action="{{ route('dashboard.virtual-classes.mass-delete') }}" method="POST">
                    @csrf
                    @method('DELETE')
    ...
    <div class="rounded-lg bg-white shadow">
        ...
        <div class="flow-root">
            ...
            <div class="hidden items-center bg-gray-200 md:flex">
                ...
                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Start Date</span>
                </div>
                ...
                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Attendees</span>
                </div>

                <div class="w-1/12 flex-shrink-0 flex-grow-0 px-4 py-2">
                    <span class="block text-sm font-bold uppercase">Attachments</span>
                </div>
                        ...
                        <div class="py-4">
                            ...
                            <div class="items-center md:flex">
                                ...
                                <div class="w-12 flex-shrink-0 flex-grow-0 px-4">
                                    <input class="select-me" name="select-me[]" type="checkbox" value="{{ $class->id }}">
                                </div>

                                <div class="r-2 flex-shrink-0 flex-grow-0 pl-4 text-center md:w-20">

                                    <img class="h-24 w-24 bg-gray-100 object-contain" src="{{ $class->getThumbnail() }}" />
                                ...
                                <div class="flex-grow px-4 md:w-3/12">
                                    ...
                                    <div>
                                        ...
                                        <a class="truncate text-lg font-bold text-gray-900"
                                            href="{{ route('dashboard.virtual-classes.view', [$class->id]) }}">{{ $class->getTitle() }}</a>
                                    ...
                                    <div>
                                        ...
                                        @if ($class->trainer)
                                            Trainer: <a class="font-bold text-brand-500"
                                                href="{{ route('dashboard.trainers.view', [$class->trainer_id]) }}">{{ $class->trainer->getFullName() }}</a>
                                        @endif
                                    ...
                                    <div>
                                        ...
                                        @if ($class->category)
                                            Category: {{ $class->category->getName() }}
                                        @endif
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    @if ($class->isSingle())
                                        Single
                                    @elseif ($class->isRecurring())
                                        Recurring

                                        <small class="text-sm">{{ $class->getRecurrence() }}</small>
                                    @endif
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    <span class="md:hidden">Start Date:</span>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    <span class="md:hidden">Attendee Count:</span>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    <span class="md:hidden">Attachment Count:</span>
                                ...
                                <div class="flex-shrink-0 flex-grow-0 px-4 md:w-1/12">
                                    ...
                                    <div>
                                        <span class="md:hidden">View Scope:</span>
                                ...
                                <div class="flex flex-shrink-0 flex-grow-0 justify-end px-4 md:w-1/12">
                                    ...
                                    <a class="cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="{{ route('dashboard.virtual-classes.edit', [$class->id]) }}"> Edit </a>
                                    ...
                                    <a class="ml-2 cursor-pointer items-center rounded-full border border-gray-300 bg-white px-2.5 py-0.5 text-sm font-medium leading-5 text-gray-700 shadow-sm hover:bg-gray-50"
                                        href="#"
                                        onclick="if(confirm('Are you sure you want to delete this virtual class?')) document.getElementById('delete_course_{{ $class->id }}').submit()">
                                        Delete </a>

                                    <form action="{{ route('dashboard.virtual-classes.delete', [$class->id]) }}"
                                        class="inline" id="delete_course_{{ $class->id }}" method="POST">
